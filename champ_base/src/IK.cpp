    ...
    kinematics_(base_)
{
    ...
    // this->declare_parameter("target_x", 1.0); // Default X position
    // this->declare_parameter("target_y", 0.5); // Default Y position
    // this->declare_parameter("target_z", 0.3); // Default Z position
    // this->declare_parameter("target_roll", 0.0); // Default Roll
    // this->declare_parameter("target_pitch", 0.0); // Default Pitch
    // this->declare_parameter("target_yaw", 0.0); // Default Yaw
    // Remove cmd_vel_subscription_ since no longer needed
